...
class _DetectionViewState extends State<DetectionView> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CameraGalleryViewModel(),
      child: Scaffold(
        backgroundColor: Colors.white,
        body: Consumer<CameraGalleryViewModel>(
          builder: (context, viewModel, child) {
            return ViewModelBuilder<ImageClassifierModel>.reactive(
                ...
                viewModelBuilder: () => ImageClassifierModel());
          },
        ),
      ),
    );
