        ...
        children: <Widget>[
          Stack(children: <Widget>[
            ...
            Positioned(
              ...
              child: Image(
                image: AssetImage(plantList[widget.index].imageUrl),
                fit: BoxFit.cover,
                height: 250.0,
              ),
            ),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Wrap(children: [
                        Text(
                          plantList[widget.index].alltoknow,
                          style: TextStyle(
                            fontFamily: 'Montserrat',
                            fontSize: 14.0,
                          ),
                    ...
                    SizedBox(height: 10.0),
                    if (plantList[widget.index].anomalies != null)
                      for (int i = 0;
                          i < plantList[widget.index].anomalies.length;
                          i++)
                        Text(
                          plantList[widget.index].anomalies[i],
                          style: TextStyle(
                            fontFamily: 'Montserrat',
                            fontSize: 14.0,
                          ),
