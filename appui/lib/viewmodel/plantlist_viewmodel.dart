...
class PlantListViewModel extends ChangeNotifier {
  ...
  String changeDescription1(List<Plantinfo> list) {
    _model.description = _model.list[index].description;
    _model.plant = _model.list[index].name;
